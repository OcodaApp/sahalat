...
class EditMapSearchView extends StatefulWidget {
  const EditMapSearchView({Key? key}) : super(key: key);
  @override
  State<EditMapSearchView> createState() => EditMapSearchViewState();
}
class EditMapSearchViewState extends State<EditMapSearchView> {
            ...
            child: GoogleMap(
              ...
              onCameraIdle: () async {
                ...
                List<Placemark> placemarks = await placemarkFromCoordinates(
                  ...
                  // localeIdentifier: langController.appLocale == 'ar' ? 'ar' : 'en',
                );
