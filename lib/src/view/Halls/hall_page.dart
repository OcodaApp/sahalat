...
import '../Home/controllers/provider_one_controller.dart';
import '../Restaurants/product_view.dart';
import '../events/section_page.dart';

class HallPage extends StatelessWidget {
  HallPage({Key? key,required this.providers,this.sectionsData}) : super(key: key);
  final ProviderOneController controller = Get.put(ProviderOneController());
  ...
  Widget build(BuildContext context) {
    ...
    controller.timeChoose.value = ('${date.hour}:${date.minute}').toString();
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image:  DecorationImage(
                                  image: NetworkImage(controller.provider.image,),
                                  fit: BoxFit.fill,
                                ),
                              ),
                            ),
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      SmoothStarRating(
                        ...
                        starCount: 5,
                        rating: controller.provider.rateAvg,
                        size: sizeW15,
                  ...
                  sectionsData.type != 'halls' && sectionsData.type != 'photographers' ?Row(
                    children: [
                      ...
                      Text('${controller.provider.fromTime} - ${controller.provider.toTime} ',style: TextStyle(color: blackolor,fontSize: sizeW14,fontWeight: FontWeight.w400),),
                    ],
                  ):Container(),
                    ...
                    children: [
                      sectionsData.type == 'photographers' ? Row(
                        children: [
                          ...
                          SizedBox(width: sizeW10,),
                          Expanded(child: Text(controller.provider.categoryName,style: TextStyle(color: blackolor,fontSize: sizeW14,fontWeight: FontWeight.w400),)),
                        ],
                      ):Container(),
                  ...
                  sectionsData.isaddress && sectionsData.type != 'events'? Row(
                    children: [
                      ...
                      SizedBox(width: sizeW10,),
                      Expanded(child: Text(controller.provider.locationText,
                  ...
                  Row(
                    children: [
                      ...
                      sectionsData.ispersoncount?Text(controller.provider.personCount,style: TextStyle(color: blackolor,fontSize: sizeW14,fontWeight: FontWeight.w400),):Container(),
                      ...
                      sectionsData.isprice?Text(controller.provider.price,style: TextStyle(color: blackolor,fontSize: sizeW14,fontWeight: FontWeight.w400),):Container(),
                    ],
                  ),
                  sectionsData.iscategories   ? Column(
                 ...
                 sectionsData.isproducts && controller.isProducts.value && controller.productsData.isNotEmpty && sectionsData.type != 'events'?  SizedBox(
                    height: sizeH100 *(controller.productsData.length+1.1),
                  ...
                  SizedBox(height: sectionsData.isproducts && controller.isProducts.value&& controller.productsData.isNotEmpty&& sectionsData.type != 'events'?sizeH20:0,),
                  
                  SizedBox(height: sizeH20,),
                  Container(height: 1,width: Get.width,color: greyOpacityColor,),
                  SizedBox(height: sizeH20,),
                  sectionsData.isdesc ?  Column(
                    mainAxisAlignment: MainAxisAlignment.start,
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('${sectionsData.descname}',style: TextStyle(color: primaryColor,fontSize: sizeW16,fontWeight: FontWeight.w700),),
                      SizedBox(height: sizeH10,),
                  ...
                  sectionsData.isimages && controller.provider.images.length > 0?Column(
                    children: [
                      SizedBox(
                        height: Get.height / 7,
                        child: ListView.builder(
                  ...
                  sectionsData.type == 'photographers' && controller.provider.packages.length>0? Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(sectionsData.packagesname,style: TextStyle(color: primaryColor,fontSize: sizeW16,fontWeight: FontWeight.w700),),
                      SizedBox(height: sizeH20,),
                      Column(
                      ...
                      if(General.token != ''){
                        ...
                        if(sectionsData.type == 'photographers'){
                          if(controller.packageChoose.value >0){
                            controller.getAddBasketPackages();
                          }else{
                            ScaffoldMessenger.of(context).showSnackBar(
                          ...
                          if(controller.serviceChooses.isNotEmpty){
                            for (var map in controller.serviceChooses) {
                              if (map.containsKey("id")) {
                                total = total+ int.parse(map["total"].toString());
                              }
                            }
                            controller.getAddBasketServices(total);
                          }else{
                            ScaffoldMessenger.of(context).showSnackBar(
                  ...
                  Text('${sectionsData.title} ${'outher providers'.tr}',style: TextStyle(color: primaryColor,fontSize: sizeW16,fontWeight: FontWeight.w700),),
                  SizedBox(height: sizeH20,),
                  SizedBox(
                    height: Get.height / 7,
                    child: ListView.builder(
                      ...
                      scrollDirection: Axis.horizontal,
                      itemBuilder: (BuildContext context, int index) {
                        return providers[index].id != controller.provider.id? GestureDetector(
                          onTap: (){
                            controller.sectionsShow.value = false;
                            controller.providerId.value = providers[index].id;
                            controller.provider = providers[index];
                            controller.sectionId.value = 0;
                            controller.getProductssList();
                          },
                          child: Container(
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(sizeW15),
                                    image: DecorationImage(
                                      image: NetworkImage(providers[index].image,),
                                      fit: BoxFit.fill,
                                    ),
                                  ),
                                ),
